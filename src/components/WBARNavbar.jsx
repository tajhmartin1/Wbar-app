...
const WBARNavbar = () => {
    ...
    return (
        <nav
            ...
            <div
                className="bg-purple-900 bg-opacity-55 backdrop-blur-xl m-5 max-w-screen-xl flex flex-wrap items-center justify-between px-4 mx-auto rounded-2xl transition-all duration-700 ease-in-out">
                <Link to="/">
                        ...
                        {!session &&
                            <li className={'border-t pt-3'}>
                                <Link className={'flex flex-col gap-2 items-baseline'} to={"/login"}>
                                    <button
                                        className="ml-2 hover:bg-purple-100 bg-opacity-15 hover:text-purple-500 border rounded-xl text-2xl py-2 px-3 font-black uppercase">Login
                                    </button>
                                    <div className={'font-medium'}>^ DJs, STAFF, E-BOARD</div>
                                </Link>
                            </li>}
                        {session &&
                            <li className={'border-t pt-3 sm:hidden'}>
                                <Avatar />
                            </li>
                        }
                    </ul>
